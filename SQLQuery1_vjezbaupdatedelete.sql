...
update polaznici set prezime='Šuler', oib='12345678901', brojugovora='25/2023'
where sifra=17;
...
update smjerovi set cijena=1000 where sifra>1;
...
update smjerovi set upisnina=cijena*0.15;
...
values ('Python progamiranje');

delete from polaznici
select * from clanovi;
select * from polaznici;

delete from clanovi where polaznik=28;